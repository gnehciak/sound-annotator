...
| `lyricsSectionColor` | boolean | `true` colours each lyric line on the video in the hue of the section it starts in (lifted to read on the picture) instead of white. Off by default. |

...
//
// Four lists are ours, not the bank's, because a bank of describing words has
// no equivalent: Instrument / section, Sound produced by, Layer role, and the
// Dynamic level ladder (ppp–fff).
//
